...
constexpr int WIDTH_GRANADE_EXPLOTION= 40;
constexpr int HEIGHT_BULLET= 3;
constexpr int WIDTH_BULLET= 3;
const uint8_t WIDTH_ARMOR= 27;
const uint8_t HEIGHT_ARMOR= 42;
const uint8_t WIDTH_HELMET= 39;
const uint8_t HEIGHT_HELMET= 40;
...
const int QUEUE_TAMANIO_MAX = 100;
