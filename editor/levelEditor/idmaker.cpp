...
int IDMaker::get_id_platform(std::string platform_name) { return platforms_id.at(platform_name); }

int IDMaker::get_id_weapon(std::string weapon_name) { return weapons_id.at(weapon_name); }

int IDMaker::get_id_armour(std::string armour_name) { return armours_id.at(armour_name); }

int IDMaker::get_id_wall(std::string wall_name) { return walls_id.at(wall_name); }
