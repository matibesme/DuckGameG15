...
void LevelEditor::show_menu_context(const QPoint &pos) {
  ...
  connect(action_city_background, &QAction::triggered,
          [this, action_city_background]() {
            controller->set_background(action_city_background->text());
          });
  connect(action_forest_background, &QAction::triggered,
          [this, action_forest_background]() {
            controller->set_background(action_forest_background->text());
          });

  connect(action_cloudyNight_background, &QAction::triggered,
          [this, action_cloudyNight_background]() {
  ...
  connect(action_chestplate_armour, &QAction::triggered,
          [this, action_chestplate_armour]() {
  ...
  connect(action_knigthsHelmet_armour, &QAction::triggered,
          [this, action_knigthsHelmet_armour]() {
...
void LevelEditor::add_submenu_weapons(QMenu &menu) {
  ...
  connect(action_ak47_weapon, &QAction::triggered,
          [this, action_ak47_weapon]() {
  ...
  connect(action_banana_weapon, &QAction::triggered,
          [this, action_banana_weapon]() {
  ...
  connect(action_cowboyPistol_weapon, &QAction::triggered,
          [this, action_cowboyPistol_weapon]() {
  ...
  connect(action_duelingPistol_weapon, &QAction::triggered,
          [this, action_duelingPistol_weapon]() {
  ...
  connect(action_grenade_weapon, &QAction::triggered,
          [this, action_grenade_weapon]() {
  ...
  connect(action_laserRifle_weapon, &QAction::triggered,
          [this, action_laserRifle_weapon]() {
  ...
  connect(action_magnum_weapon, &QAction::triggered,
          [this, action_magnum_weapon]() {
  ...
  connect(action_pewPewLaser_weapon, &QAction::triggered,
          [this, action_pewPewLaser_weapon]() {
  ...
  connect(action_shotgun_weapon, &QAction::triggered,
          [this, action_shotgun_weapon]() {
  ...
  connect(action_sniper_weapon, &QAction::triggered,
          [this, action_sniper_weapon]() {
...
void LevelEditor::add_submenu_platforms(QMenu &menu) {
  ...
  connect(action_industrial_platform, &QAction::triggered,
          [this, action_industrial_platform]() {
  ...
  connect(action_Donut_platform, &QAction::triggered,
          [this, action_Donut_platform]() {
  ...
  connect(action_Nature_platform, &QAction::triggered,
          [this, action_Nature_platform]() {
  ...
  connect(action_Space_platform, &QAction::triggered,
          [this, action_Space_platform]() {
  ...
  connect(action_Underground_platform, &QAction::triggered,
          [this, action_Underground_platform]() {
  ...
  connect(action_DonutLarga_platform, &QAction::triggered,
          [this, action_DonutLarga_platform]() {
  ...
  connect(action_NatureLarga_platform, &QAction::triggered,
          [this, action_NatureLarga_platform]() {
...
void LevelEditor::add_submenu_walls(QMenu &menu) {
  ...
  connect(action_nature_wall, &QAction::triggered,
          [this, action_nature_wall]() {
  ...
  connect(action_underground_wall, &QAction::triggered,
          [this, action_underground_wall]() {
