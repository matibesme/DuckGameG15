...
void LevelEditor::show_menu_context(const QPoint& pos) {
    ...
    connect(action_save, &QAction::triggered, [this, action_save]() { controller->save_map(); });
...
void LevelEditor::add_submenu_walls(QMenu& menu) {
    ...
    connect(action_donut_wall, &QAction::triggered,
            [this, action_donut_wall]() { controller->set_wall(action_donut_wall->text()); });
    ...
    connect(action_nature_wall, &QAction::triggered,
            [this, action_nature_wall]() { controller->set_wall(action_nature_wall->text()); });
