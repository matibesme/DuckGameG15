...
void Boxes::generateRandomContent() {
    ...
    switch (random_number) {
        ...
        case 2:
            ...
            break;
        case 3:
            map_armor.emplace(id_defense++, Protection{ARMOR_EQUIPPED , x_pos, y_pos+HEIGHT_BOX-HEIGHT_ARMOR});
            break;
        case 4:
            map_helmet.emplace(id_defense++, Protection{HELMET_EQUIPPED, x_pos, y_pos+HEIGHT_BOX-HEIGHT_HELMET});
            break;
        case 5:
