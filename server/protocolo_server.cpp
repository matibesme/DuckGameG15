...
void ProtocoloServer::sendFullGame(const CommandFullGame& command) {
    try {
...
void ProtocoloServer::sendVictory(const CommandVictory& command) {
    try {
...
void ProtocoloServer::sendEndOfRound(const CommandEndOfRound& command) {
    try {
