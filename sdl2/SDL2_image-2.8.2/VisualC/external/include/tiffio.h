...
extern int TIFFReadRGBATileExt(TIFF *, uint32, uint32, uint32 *,
                               int stop_on_error);
...
extern tmsize_t TIFFReadRawTile(TIFF *tif, uint32 tile, void *buf,
                                tmsize_t size);
extern int TIFFReadFromUserBuffer(TIFF *tif, uint32 strile, void *inbuf,
...
extern uint64 TIFFGetStrileByteCountWithErr(TIFF *tif, uint32 strile,
                                            int *pbErr);
