...
#define TIFFTAG_IRASB_TRANSORMATION_MATRIX                                     \
  33920 /* Originally part of Intergraph's GeoTIFF tags, but likely understood \
           by IrasB only. */
...
#define EXIFTAG_TEMPERATURE                                                    \
  37888 /* Temperature as the ambient situation at the shot in dergee Celsius  \
         */
...
#define EXIFTAG_LENSSPECIFICATION                                              \
  42034 /* minimum focal length (in mm), maximum focal length (in mm), minimum \
...
#define GPSTAG_ALTITUDE                                                        \
  6 /* 	Indicates the altitude based on the reference in GPSAltitudeRef.       \
     */
...
#define GPSTAG_STATUS                                                          \
  9 /* 	Indicates the status of the GPS receiver when the image is recorded.   \
     */
...
#define GPSTAG_TRACKREF                                                        \
  14 /* 	Indicates the reference for giving the direction of GPS receiver      \
        movement.	 */
#define GPSTAG_TRACK                                                           \
  15 /* 	Indicates the direction of GPS receiver movement.	 */
#define GPSTAG_IMGDIRECTIONREF                                                 \
  16 /* 	Indicates the reference for giving the direction of the image when it \
        is captured.	 */
#define GPSTAG_IMGDIRECTION                                                    \
  17 /* 	Indicates the direction of the image when it was captured.            \
      */
#define GPSTAG_MAPDATUM                                                        \
  18 /* 	Indicates the geodetic survey data used by the GPS receiver. (e.g.    \
        WGS-84)	 */
#define GPSTAG_DESTLATITUDEREF                                                 \
  19 /* 	Indicates whether the latitude of the destination point is north or   \
        south latitude.	 */
#define GPSTAG_DESTLATITUDE                                                    \
  20 /* 	Indicates the latitude of the destination point.	 */
#define GPSTAG_DESTLONGITUDEREF                                                \
  21 /* 	Indicates whether the longitude of the destination point is east or   \
        west longitude.	 */
...
#define GPSTAG_DESTDISTANCEREF                                                 \
  25 /* 	Indicates the unit used to express the distance to the destination    \
        point.	 */
#define GPSTAG_DESTDISTANCE                                                    \
  26 /* 	Indicates the distance to the destination point.	 */
#define GPSTAG_PROCESSINGMETHOD                                                \
  27 /* 	A character string recording the name of the method used for location \
        finding.	 */
#define GPSTAG_AREAINFORMATION                                                 \
  28 /* 	A character string recording the name of the GPS area.	 */
#define GPSTAG_DATESTAMP                                                       \
  29 /* 	A character string recording date and time information relative to    \
        UTC (Coordinated Universal Time).	 */
#define GPSTAG_DIFFERENTIAL                                                    \
  30 /* 	Indicates whether differential correction is applied to the GPS       \
        receiver.	 */
