...
WEBP_EXTERN int WebPDemuxGetFrame(const WebPDemuxer *dmux, int frame_number,
                                  WebPIterator *iter);
...
WEBP_EXTERN int WebPDemuxGetChunk(const WebPDemuxer *dmux, const char fourcc[4],
...
WebPAnimDecoderOptionsInit(WebPAnimDecoderOptions *dec_options) {
...
WebPAnimDecoderNewInternal(const WebPData *, const WebPAnimDecoderOptions *,
                           int);
...
static WEBP_INLINE WebPAnimDecoder *
...
WEBP_EXTERN int WebPAnimDecoderGetNext(WebPAnimDecoder *dec, uint8_t **buf,
                                       int *timestamp);
...
WebPAnimDecoderGetDemuxer(const WebPAnimDecoder *dec);
