...
void Platform::draw() {
  ...
  // creo una textura para dibujar las plataformas pero vacía porque no se puede
  // dibujar directamente en la pantalla
  SDL2pp::Texture platform(renderer, SDL_PIXELFORMAT_RGBA8888,
                           SDL_TEXTUREACCESS_TARGET, SCENE_WIDTH, SCENE_HEIGHT);
